...
- **[k8s-inference-ops](https://github.com/JamesIOmete/k8s-inference-ops)** — Kubernetes deployment patterns for an AI-style inference service; the deployment layer this agent would monitor and operate against
